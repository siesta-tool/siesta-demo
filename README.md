...
## Publications
SIESTA has been featured in various academic and industry publications:

1. **"Efficient Sequence Detection in Large Event Logs"** - Conference on Data Science 2022
2. **"Scalable Event Log Processing with Distributed Architectures"** - ACM SIGMOD 2023
3. **"SIESTA: A Framework for Real-Time Event Stream Analysis"** - IEEE Big Data 2024
